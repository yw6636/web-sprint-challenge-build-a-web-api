...
async function checkNewAction (req, res, next) {
    ...
    if (description !== undefined && typeof description === 'string' && description.length && description.trim().length
        && description.length < 129 && notes!== undefined && notes.length && notes.trim().length
    ){
        next()
    }
    else {
...
module.exports = {
    checkActionId, checkNewAction, checkValidProject
}